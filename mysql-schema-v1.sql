...
CREATE TABLE IF NOT EXISTS department (
    ...
    updated_at DATETIME(6) NOT NULL,
    PRIMARY KEY (id),
    UNIQUE KEY uk_department_code (hospital_id, department_code),
...
CREATE TABLE IF NOT EXISTS doctor (
    ...
    hot_expert TINYINT(1) NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS schedule_slot (
    ...
    hot_slot TINYINT(1) NOT NULL DEFAULT 0,
    ...
    KEY idx_slot_status_date (status, slot_date)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS registration_order (
    ...
    KEY idx_order_patient_phone (patient_phone),
    KEY idx_order_status_date (status, visit_date)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
CREATE TABLE IF NOT EXISTS knowledge_chunk (
    ...
    updated_at DATETIME(6) NOT NULL,
    PRIMARY KEY (id),
    UNIQUE KEY uk_chunk_key (hospital_id, chunk_key),
